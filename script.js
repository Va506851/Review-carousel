...
const Profileprofession = document.querySelector(".profile-profession");
...
const reviews = [
  ...
  window.addEventListener('DOMContentLoaded',()=>{
    ...
    Profilename.textContent = review.name;
    Profileprofession.textContent = review.job;
    Profileabout.textContent = review.text;
  })
